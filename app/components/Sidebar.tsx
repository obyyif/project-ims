...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={`
          fixed inset-y-0 left-0 z-50 flex w-72 flex-col bg-white card-float
      ...
      >
        ...
        <div className="flex items-center gap-3 px-6 pt-7 pb-2">
          ...
          <button
            onClick={onClose}
            className="ml-auto rounded-xl p-2 text-slate-400 hover:bg-slate-100 hover:text-slate-600 md:hidden"
          >
        ...
        <div className="border-t border-slate-100 px-3 py-4 space-y-1">
          ...
          <button
            onClick={logout}
            className="flex w-full items-center gap-3 rounded-2xl px-4 py-3 text-sm font-medium text-rose-500 transition-all hover:bg-rose-50"
          >
